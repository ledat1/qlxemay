          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            <tbody>
              ...
              <tr role="row" class="odd">
                ...
                <td class="sorting_1">{{date('d-m-Y', strtotime($sanpham->ngaymuahang))}}</td>
                <td style="width: 50px;">
                  <button type="button" class="btn btn-block btn-default btn-sm"><a href="http://localhost:8000/admin/hoadon/xem/{{ $sanpham->id_hoadon }}">Xem</a></button>
                </td>
              </tr>
