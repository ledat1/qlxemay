...
@section('title', 'Quản lí nhập kho')
...
<div class="box-header">
    ...
    <form action="{{ route('timKiemNhapKho') }}" method="get" role="search">

    <div class="box-tools">
        <div class="input-group input-group-sm hidden-xs" style="width: 200px; float: left; margin-left: 10px;">
            <input type="text" name="spnk" class="form-control pull-right" placeholder="Tìm kiếm">
...
<form action="{{ route('timKiemNhapKho2') }}" method="get" role="search">

<div class="box-tools">
  <div class="input-group input-group-sm hidden-xs ok" style="width: 218px; float: left; margin-left: 90px;bottom: 18px">
   
  <input type="month" name="spnk3" class="form-control pull-right" placeholder="Tìm kiếm">
            <div class="input-group-btn">
                <button type="submit" class="btn btn-default"><i class="fa fa-search"></i></button>
            </div>
  </div>
          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            <tbody>
              ...
              <tr role="row" class="odd">
                ...
                <td class="sorting_1">  {{ number_format($nhapkho->Gianhap,0,',','.')}} VNĐ</td>
                <td class="sorting_1">
