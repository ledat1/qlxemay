    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'url'  => 'admin/nhanvien/danhsach',
                ],
                [
                    'text' => 'Quá trình bảo hành',
                    'url'  => 'admin/baohanh/danhsach',
                ],
            ],
            'can'   => 'xemToanBo'
        ],
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Nhập kho',
                    'url'  => 'admin/nhapkho/danhsach',
                ],
                [
                    'text' => 'Xuất kho',
                    'url'  => 'admin/xuatkho/danhsach',
                ],
            ],
            'can'   => 'xemToanBoNV'
        ],
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'url'  => 'admin/hoadon/danhsach',
                ],
            ],
            'can'   => 'xemToanBo'
        ],
        [
            'text'    => 'HÓA ĐƠN CỦA NHÂN VIÊN',
            'icon'    => 'fas fa-adjust',
            'submenu' => [
                [
                    'text' => 'Danh sách hóa đơn',
                    'url'  => 'admin/nhanvien/hoadon',
                ],
            ],
            'can'   => 'xemToanBoNV'
        ],
